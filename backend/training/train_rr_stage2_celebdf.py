"""
E-Raksha RR Model Training - Stage 2: CelebDF

Resolution/Re-recording Specialist Model with enhanced upscaling detection.
Optimized for resolution inconsistencies and re-recording pattern analysis.

Progressive Training Strategy:
- Stage 1: FaceForensics++ (Foundation) ✓
- Stage 2: CelebDF (Resolution adaptation) ← THIS SCRIPT
- Stage 4: DFDC (Large-scale validation)

Model Architecture:
- EfficientNet-B4 backbone with 36-channel specialist module
- Advanced upscaling detection algorithms
...
import zipfile
from IPython.display import FileLink, displaywarnings.filterwarnings('ignore')

# ============================================================================
# CONFIGURATION - UPDATE THESE PATHS
# ============================================================================
DATASET_PATH = '/kaggle/input/celeb-df-v2'
STAGE1_CHECKPOINT = '/kaggle/input/rr-stage1-model/rr_stage1_final.pt'  # UPDATE THIS PATH
...
print(f"🚀 RR MODEL - STAGE 2: CELEB-DF TRAINING")
...
def main():
    ...
    print("\n🚀 STARTING RR MODEL STAGE 2 TRAINING")
    print("="*80)
