"""
E-Raksha TM Model Training - Stage 1: FaceForensics++

Advanced Temporal Specialist Model with LSTM-based temporal analysis.
Rebuilt architecture for improved temporal consistency detection and frame manipulation analysis.

Progressive Training Strategy:
- Stage 1: FaceForensics++ (Foundation) ← THIS SCRIPT
- Stage 2: CelebDF (Temporal adaptation)
- Stage 4: DFDC (Large-scale validation)

Model Architecture:
- EfficientNet-B4 backbone with LSTM temporal analysis
- Enhanced temporal consistency detection
- Advanced frame sequence analysis
- Optimized for 74% target accuracy
